...
public class InjectorMonitor {
    /**
     * Identifier of this CWI monitor.
     * Handy when we have output from multiple CWI monitors
     * and need to distinguish between them in log or console output.
     */
    private final String id;
    private boolean keepTaskList = true;
    /** List of TaskInfo objects */private final List taskList = new LinkedList();
    /** Start time of the current task */
    private long startTimeMillis;
    /** Is the stop monitor currently running? */
    ...
    /**
     * Construct a new CWI monitor. Does not start any task.
     */
     ...
     * @param id identifier for this CWI monitor.
     * Handy when we have output from multiple CWI monitors
     ...
     * "false" when using a CWIMonitor for millions of intervals, or the task
    ...
    public void start(String taskName) throws IllegalStateException {
        if (this.running) {
            throw new IllegalStateException("Can't start CWIMonitor: it's already running");
        }
    ...
    public void stop() throws IllegalStateException {
        if (!this.running) {
            throw new IllegalStateException("Can't stop CWIMonitor: it's not running");
        }
    ...
    public String shortSummary() {
        return "CWIMonitor '" + this.id + "': running time (millis) = " + getTotalTimeMillis();
    }
